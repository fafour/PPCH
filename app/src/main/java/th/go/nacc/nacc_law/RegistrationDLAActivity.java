 ...
 */
public class RegistrationDLAActivity extends AbstractActivity {
    ...
    */
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
        ...
        setContentView( R.layout.activity_registration_dla );
...
//        actionBar.setBackgroundDrawable(background);
        ...
        setTitle( "ลงทะเบียน (สำหรับสมาชิก อปท.)" );
        ...
        JobTitle.get( this, new JobTitle.OnResponseListener() {
            ...
            public void onGetListener(List<JobTitle> jobTitles, Error error) {
                if ( error == null ) {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(RegistrationDLAActivity.this,
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("ใช่", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent ( RegistrationDLAActivity.this, RegistrationActivity.class );
        ...
        Member.register(this, mMember, new Member.OnRegisterListener() {
            ...
            public void registerResult(Member member, Error error) {
                if (error == null) {
                    ...
                    LayoutInflater li = LayoutInflater.from(RegistrationDLAActivity.this);
                    View alertView = li.inflate(R.layout.alertlayout, null);
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(RegistrationDLAActivity.this);
